...
*   **Phạm vi chức năng:** Đồ án tập trung đi sâu vào logic phân bổ Gacha, thuật toán nâng cấp thẻ bài kiểu phi tuyến tính (FO4 Style), cơ chế đồng bộ kho đồ Local-First, và tương tác thời gian thực (Real-time Chat). Các luồng thanh toán bằng tiền thật (Fiat Payment Gateway) được loại bỏ khỏi phạm vi đồ án, thay thế bằng cơ chế tiền tệ ảo cục bộ để tập trung tối đa cho việc xử lý kỹ thuật tối ưu hóa.

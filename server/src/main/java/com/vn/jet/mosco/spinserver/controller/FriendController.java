...
public class FriendController {
     ...
     */
    @GetMapping("/list")
    public ResponseEntity<ApiResponse<List<Map<String, Object>>>> getFriendList(@RequestAttribute("userId") Long userId) {
     ...
     */
    @GetMapping("/requests")
    public ResponseEntity<ApiResponse<List<Map<String, Object>>>> getPendingRequests(@RequestAttribute("userId") Long userId) {
     ...
     */
    @PostMapping("/add")
    public ResponseEntity<ApiResponse<Void>> addFriend(@RequestAttribute("userId") Long userId, @RequestBody Map<String, Long> body) {
    ...
    public ResponseEntity<ApiResponse<Void>> acceptFriend(@RequestAttribute("userId") Long userId, @PathVariable Long friendshipId) {
    ...
    public ResponseEntity<ApiResponse<Void>> removeFriend(@RequestAttribute("userId") Long userId, @PathVariable Long friendshipId) {
    ...
    public ResponseEntity<ApiResponse<Void>> removeFriendByUser(@RequestAttribute("userId") Long userId, @PathVariable Long targetUserId) {
    ...
    public ResponseEntity<ApiResponse<Void>> acceptFriendByUser(@RequestAttribute("userId") Long userId, @PathVariable Long targetUserId) {
     ...
     */
    @GetMapping("/explore")
    public ResponseEntity<ApiResponse<List<Map<String, Object>>>> getExploreSuggestions(@RequestAttribute("userId") Long userId) {
